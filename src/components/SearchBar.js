  ...
  render() {
    ...
    const options = dataSource.map((player) => (
      <Option key={player.fullName} value={player.fullName} className="player-option">
        <img alt="" className="player-option-image" src={`${PROFILE_PIC_URL_PREFIX}/${player.playerId}.png`} />
    ...
    return (
      ...
      >
        <Input.Search suffix={<Icon type="search" className="certain-category-icon" />} />
      </AutoComplete>
